# Visual-diff: `lets-icons:add-duotone-line`

Generated 2026-05-16. Phase 1.5 three-way diff (see RESEARCH_PLAN §26 / §33b).

- **Package**: `iconifyx_lets_icons`
- **Primary codepoint**: `0xe008`
...
|---|---|---|
| SVG vs TTF (generator/build stage) | ![svg-vs-ttf](diff-svg-vs-ttf.png) | mismatch=10.21% ham=2 ssim=0.935 |
| TTF vs Flutter (widget render stage) | ![ttf-vs-flutter](diff-ttf-vs-flutter.png) | mismatch=0.29% ham=4 ssim=0.954 |
| SVG vs Flutter (end-to-end) | ![svg-vs-flutter](diff-svg-vs-flutter.png) | mismatch=10.06% ham=2 ssim=0.949 |

## Glyph metrics (raw TTF)

| Layer | Font | Glyph name | Advance | LSB | bbox xMin..xMax | bbox yMin..yMax | Centroid |
|---|---|---|---:|---:|---|---|---|
| primary | `LetsIcons.ttf` | `add-duotone` | 1000 | 0 | 308.0..692.0 | 308.0..692.0 | (500, 500) |
...
- Ink ratio Flutter:  0.0378
- Centroid drift: (0.0, -0.7) px
- dHash: `0000420020004200` vs `0018420020004200` (Hamming 2/64)
- SSIM: 0.9487
