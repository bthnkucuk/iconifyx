# Visual-diff: `mdi:pencil`

Generated 2026-05-16. Phase 1.5 three-way diff (see RESEARCH_PLAN §26 / §33b).

- **Package**: `iconifyx_mdi`
- **Primary codepoint**: `0xee14`
...
|---|---|---|
| SVG vs TTF (generator/build stage) | ![svg-vs-ttf](diff-svg-vs-ttf.png) | mismatch=0.10% ham=2 ssim=0.985 |
| TTF vs Flutter (widget render stage) | ![ttf-vs-flutter](diff-ttf-vs-flutter.png) | mismatch=0.15% ham=2 ssim=0.968 |
...
|---|---|---|---:|---:|---|---|---|
| primary | `Mdi_2.ttf` | `mode-edit` | 1000 | 0 | 125.0..875.0 | 125.0..875.0 | (500, 500) |

## End-to-end metrics (SVG vs Flutter)

- Canvas: 256 × 256
- Mismatch: 0 / 65,536 px (0.00 %)
- Ink ratio upstream: 0.1889
- Ink ratio Flutter:  0.1922
- Centroid drift: (0.6, -0.3) px
- dHash: `0000060810404000` vs `0000060810404000` (Hamming 0/64)
- SSIM: 0.9756
