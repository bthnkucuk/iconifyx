# Visual-diff: `solar:bell-bold-duotone`

Generated 2026-05-16. Phase 1.5 three-way diff (see RESEARCH_PLAN §26 / §33b).

- **Package**: `iconifyx_solar`
- **Primary codepoint**: `0xe247`
...
- **Confidence**: `high`
- **Problem**: Primary glyph centroid (500,156) differs from secondary (500,563) by 0.0% / 40.7% of em — layers will overlay misaligned
...
|---|---|---|
| SVG vs TTF (generator/build stage) | ![svg-vs-ttf](diff-svg-vs-ttf.png) | mismatch=0.08% ham=0 ssim=0.969 |
| TTF vs Flutter (widget render stage) | ![ttf-vs-flutter](diff-ttf-vs-flutter.png) | mismatch=0.01% ham=0 ssim=0.987 |
...
|---|---|---|---:|---:|---|---|---|
| primary | `Solar.ttf` | `bell-bold-duotone` | 1000 | 0 | 302.8..697.2 | 84.0..227.0 | (500, 156) |
| secondary | `SolarSecondary.ttf` | `bell-bing-bold-duotone` | 1000 | 0 | 125.1..875.2 | 209.0..916.3 | (500, 563) |

## End-to-end metrics (SVG vs Flutter)

- Canvas: 256 × 256
- Mismatch: 1 / 65,536 px (0.00 %)
- Ink ratio upstream: 0.0376
- Ink ratio Flutter:  0.0383
- Centroid drift: (0.1, -0.5) px
- dHash: `0010204040404010` vs `0010204040404010` (Hamming 0/64)
- SSIM: 0.9749

## Duotone alignment (TTF-space)

- **Primary centroid**: (500.0, 155.5) in em-units of 1000
- **Secondary centroid**: (500.2, 562.7)
- **Centroid delta**: (0.2, 407.2) em-units
- **Fraction of em**: (0.0 %, 40.7 %)
