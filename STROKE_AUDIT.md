...
| Set | Prefix | Stroke % | Evenodd % | Paint-order % | Duotone | Applied | Source |
|---|---|---:|---:|---:|---:|:---:|---|
| IonIcons | `ion` | 48% | 0% | 0% | — | — | none |
| Famicons | `famicons` | 48% | 0% | 0% | — | — | none |
...
| Mono Icons | `mono-icons` | 0% | 4% | 0% | — | — | none |
...
| Google Material Icons | `ic` | 0% | 0% | 0% | 1,351 | — | none |
