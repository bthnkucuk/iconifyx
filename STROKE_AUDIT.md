...
| Set | Prefix | Stroke % | Evenodd % | Applied | Source |
|---|---|---:|---:|:---:|---|
...
| Noto Emoji (v1) | `noto-v1` | 24% | 0% | — | none |
| VSCode Icons | `vscode-icons` | 8% | 12% | — | none |
| Ant Design Icons | `ant-design` | 0% | 16% | — | none |
| OpenSearch UI | `oui` | 0% | 16% | — | none |
| Material Icon Theme | `material-icon-theme` | 8% | 8% | — | none |
| TopCoat Icons | `topcoat` | 0% | 16% | — | none |
| Stash Icons | `stash` | 0% | 12% | — | none |
| Kameleon color icons | `streamline-kameleon-color` | 0% | 12% | — | none |
| Noto Emoji | `noto` | 12% | 0% | — | none |
...
| Devicon Plain | `devicon-plain` | 0% | 4% | — | none |
| Fluent Emoji Flat | `fluent-emoji-flat` | 0% | 4% | — | none |
...
| IconaMoon | `iconamoon` | 80% | 20% | ✓ | explicit |
...
| Huge Icons | `hugeicons` | 100% | 0% | ✓ | explicit |
...
| Arcticons | `arcticons` | 100% | 0% | ✓ | auto |
| OpenMoji | `openmoji` | 100% | 0% | ✓ | auto |
| Streamline Emojis | `streamline-emojis` | 100% | 0% | ✓ | auto |
...
| Bitcoin Icons | `bitcoin-icons` | 48% | 44% | ✓ | auto |
...
| Grommet Icons | `grommet-icons` | 68% | 24% | ✓ | auto |
| Solar | `solar` | 48% | 40% | ✓ | explicit |
| Sargam Icons | `si` | 68% | 24% | ✓ | auto |
| Feather Icon | `fe` | 0% | 88% | ✓ | auto |
| Gravity UI Icons | `gravity-ui` | 0% | 88% | ✓ | auto |
| Glyphs | `glyphs` | 68% | 24% | ✓ | auto |
| Glyphs Poly | `glyphs-poly` | 72% | 40% | ✓ | auto |
| Tabler Icons | `tabler` | 84% | 0% | ✓ | explicit |
...
| Cryptocurrency Color Icons | `cryptocurrency-color` | 0% | 52% | ✓ | auto |
| Duoicons | `duo-icons` | 0% | 48% | ✓ | auto |
| Skill Icons | `skill-icons` | 0% | 48% | ✓ | auto |
| Google Cloud Icons | `gcp` | 0% | 48% | ✓ | auto |
| uiw icons | `uiw` | 0% | 44% | ✓ | auto |
| MingCute Icon | `mingcute` | 0% | 40% | ✓ | auto |
| Qlementine Icons | `qlementine-icons` | 0% | 40% | ✓ | auto |
| Flat UI Icons | `flat-ui` | 4% | 36% | ✓ | auto |
| SidekickIcons | `sidekickicons` | 28% | 4% | ✓ | explicit |
| Web3 Icons | `token` | 0% | 32% | ✓ | auto |
| CoreUI Flags | `cif` | 28% | 28% | ✓ | auto |
| Cryptocurrency Icons | `cryptocurrency` | 0% | 28% | ✓ | auto |
| WordPress Icons | `wordpress` | 0% | 24% | ✓ | auto |
| FormKit Icons | `formkit` | 4% | 20% | ✓ | auto |
| Radix Icons | `radix-icons` | 0% | 24% | ✓ | explicit |
| File Icons | `file-icons` | 0% | 24% | ✓ | auto |
| Devicon | `devicon` | 0% | 20% | ✓ | auto |
| Web3 Icons Branded | `token-branded` | 0% | 20% | ✓ | auto |
...
| Google Material Icons | `ic` | 0% | 0% | — | none |
...
| Phosphor | `ph` | 0% | 0% | — | none |
| Clarity | `clarity` | 0% | 0% | — | none |
| Memory Icons | `memory` | 0% | 0% | — | none |
| Zondicons | `zondicons` | 0% | 0% | — | none |
| Evil Icons | `ei` | 0% | 0% | — | none |
...
| Twitter Emoji | `twemoji` | 0% | 0% | — | none |
| Fluent Emoji High Contrast | `fluent-emoji-high-contrast` | 0% | 0% | — | none |
| Emoji One (Colored) | `emojione` | 0% | 0% | — | none |
| Firefox OS Emoji | `fxemoji` | 0% | 0% | — | none |
