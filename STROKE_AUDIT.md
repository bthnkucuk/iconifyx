...
- **Sets containing duo-tone icons:** 71 (22,708 icons across them)
- **Sets with ≥20% paint-order risk (multi-fill bodies that would render as monochrome blobs):** 10
- **Icons proactively dropped this run for paint-order risk:** 12,565
- **Icons recovered this run via vtracer (paint-order → duotone):** 4,593
...
| Circle Flags | `circle-flags` | 23 | 3% | `it-21`, `it-23`, `it-25` |
...
- **Total vtracer candidates this run:** 4,593
- **Recovered as paint-order duotone:** 4,593 (100%)
- **Still dropped (monochrome trace / panic / other-fail):** 0

| Set | Prefix | Considered | Recovered | Failed | Recovery % | Spot-check |
|---|---|---:|---:|---:|---:|---|
| Twitter Emoji | `twemoji` | 3,861 | 3,861 | 0 | 100% | `1st-place-medal`, `2nd-place-medal`, `3rd-place-medal` |
| Circle Flags | `circle-flags` | 732 | 732 | 0 | 100% | `aa`, `ab`, `ac` |
...
| Material Icon Theme | `material-icon-theme` | 8% | 8% | 4% | 35 | 540 | — | none |
...
| Twitter Emoji | `twemoji` | 0% | 0% | 0% | 35 | 4,498 | — | none |
...
| Circle Flags | `circle-flags` | 0% | 0% | 0% | 5 | 732 | — | none |
