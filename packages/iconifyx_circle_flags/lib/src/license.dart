...
/// Compile-time pack info for the "circle-flags" icon set.
///
...
const PackInfo packInfo = PackInfo(
  ...
  license: IconSetLicense(
    ...
    name: 'Circle Flags',
    author: 'HatScripts',
    authorUrl: 'https://github.com/HatScripts/circle-flags',
    licenseTitle: 'MIT',
    licenseSpdx: 'MIT',
    licenseUrl: 'https://github.com/HatScripts/circle-flags/blob/gh-pages/LICENSE',
    iconCount: 737,
  ),
);

/// License metadata for the "circle-flags" icon set.
///
