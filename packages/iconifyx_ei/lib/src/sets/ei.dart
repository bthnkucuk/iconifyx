...
// Source: @iconify/json v2.2.472, set "ei"
// Regenerate via `bun run generate --set ei`.
...
class EiIcons {
  ...
  /// `sc-facebook`
  static const IconifyIconData scFacebook = IconifyIconData(IconData(
    0xe02a,
    fontFamily: 'Ei',
    fontPackage: 'iconifyx_ei',
  ));
  ...
  /// `sc-github`
  static const IconifyIconData scGithub = IconifyIconData(IconData(
    0xe02b,
    fontFamily: 'Ei',
    fontPackage: 'iconifyx_ei',
  ));
  ...
  /// `sc-google-plus`
  static const IconifyIconData scGooglePlus = IconifyIconData(IconData(
    0xe02c,
    fontFamily: 'Ei',
    fontPackage: 'iconifyx_ei',
  ));
