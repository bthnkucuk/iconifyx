...
// Source: @iconify/json v2.2.472, set "svg-spinners"
// Regenerate via `bun run generate --set svg-spinners`.
...
@staticIconProvider
class SvgSpinnersIcons {
  const SvgSpinnersIcons._();
  ...
  static const IconifyIconData wifi = IconifyIconData.solo(
    IconData(0xe019, fontFamily: 'SvgSpinners', fontPackage: 'iconifyx_svg_spinners'),
  );

  /// `wifi-fade`
  static const IconifyIconData wifiFade = IconifyIconData.solo(
    IconData(0xe01a, fontFamily: 'SvgSpinners', fontPackage: 'iconifyx_svg_spinners'),
  );
