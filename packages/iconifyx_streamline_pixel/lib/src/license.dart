...
/// Compile-time pack info for the "streamline-pixel" icon set.
///
...
const PackInfo packInfo = PackInfo(
  ...
  license: IconSetLicense(
    ...
    name: 'Pixel free icons',
    author: 'Streamline',
    authorUrl: 'https://github.com/webalys-hq/streamline-vectors',
...
/// License metadata for the "streamline-pixel" icon set.
///
