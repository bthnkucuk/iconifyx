...
/// Compile-time pack info for the "heroicons-outline" icon set.
///
...
const PackInfo packInfo = PackInfo(
  ...
  license: IconSetLicense(
    ...
    authorUrl: 'https://github.com/tailwindlabs/heroicons',
    licenseTitle: 'MIT',
    licenseSpdx: 'MIT',
...
/// License metadata for the "heroicons-outline" icon set.
///
