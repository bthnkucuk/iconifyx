...
/// Compile-time pack info for the "vscode-icons" icon set.
///
...
const PackInfo packInfo = PackInfo(
  ...
  license: IconSetLicense(
    ...
    authorUrl: 'https://github.com/vscode-icons/vscode-icons',
    licenseTitle: 'MIT',
    licenseSpdx: 'MIT',
...
/// License metadata for the "vscode-icons" icon set.
///
