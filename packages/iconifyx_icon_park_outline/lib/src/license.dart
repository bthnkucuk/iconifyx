...
/// Compile-time pack info for the "icon-park-outline" icon set.
///
...
const PackInfo packInfo = PackInfo(
  ...
  license: IconSetLicense(
    ...
    name: 'IconPark Outline',
    author: 'ByteDance',
    authorUrl: 'https://github.com/bytedance/IconPark',
...
/// License metadata for the "icon-park-outline" icon set.
///
