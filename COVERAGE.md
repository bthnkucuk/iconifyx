...
Generated 2026-05-13 from `@iconify/json` v2.2.472. Source counts are Iconify's `info.total`; Built counts are live (non-deprecated) icons in our manifests.
...
## Missing sets (0 icons built)

| Set | Prefix | Source icons |
|---|---|---:|
| Fluent UI System Color Icons | `fluent-color` | 890 |
| SVG Spinners | `svg-spinners` | 46 |

## Partially built (≥5% gap)
...
| Prime Icons | `prime` | 313 | 313 | 0 | ✓ |
| Circum Icons | `circum` | 288 | 288 | 0 | ✓ |
| Feather Icon | `fe` | 255 | 255 | 0 | ✓ |
| Bitcoin Icons | `bitcoin-icons` | 330 | 330 | 0 | ✓ |
| Unicons Thin Line | `uit` | 216 | 216 | 0 | ✓ |
| Unicons Solid | `uis` | 190 | 190 | 0 | ✓ |
| Gridicons | `gridicons` | 207 | 207 | 0 | ✓ |
| Mono Icons | `mi` | 180 | 180 | 0 | ✓ |
| Cuida Icons | `cuida` | 182 | 182 | 0 | ✓ |
| WeUI Icon | `weui` | 162 | 162 | 0 | ✓ |
| Duoicons | `duo-icons` | 91 | 91 | 0 | ✓ |
| Ultimate free icons | `streamline-ultimate` | 1,999 | 1,999 | 0 | ✓ |
...
| Lsicon | `lsicon` | 716 | 716 | 0 | ✓ |
| Gravity UI Icons | `gravity-ui` | 781 | 781 | 0 | ✓ |
| Element Plus | `ep` | 293 | 293 | 0 | ✓ |
| Pixel free icons | `streamline-pixel` | 662 | 662 | 0 | ✓ |
| Streamline Block | `streamline-block` | 300 | 300 | 0 | ✓ |
...
| CodeX Icons | `codex` | 78 | 78 | 0 | ✓ |
| Evil Icons | `ei` | 70 | 70 | 0 | ✓ |
| SidekickIcons | `sidekickicons` | 232 | 232 | 0 | ✓ |
| Pepicons Pencil | `pepicons-pencil` | 1,275 | 1,275 | 0 | ✓ |
| Flex free icons | `streamline-flex` | 1,500 | 1,500 | 0 | ✓ |
...
| Covid Icons | `covid` | 142 | 142 | 0 | ✓ |
| Entypo+ | `entypo` | 321 | 321 | 0 | ✓ |
| Icons8 Windows 10 Icons | `icons8` | 234 | 234 | 0 | ✓ |
| Innowatio Font | `iwwa` | 105 | 105 | 0 | ✓ |
| BoxIcons v2 Solid | `bxs` | 665 | 665 | 0 | ✓ |
| Font Awesome 5 Regular | `fa-regular` | 151 | 151 | 0 | ✓ |
| Fluent UI MDL2 | `fluent-mdl2` | 1,735 | 1,735 | 0 | ✓ |
| Fontisto | `fontisto` | 615 | 615 | 0 | ✓ |
| IcoMoon Free | `icomoon-free` | 491 | 491 | 0 | ✓ |
| Open Iconic | `oi` | 223 | 223 | 0 | ✓ |
| Elegant | `et` | 100 | 100 | 0 | ✓ |
| Elusive Icons | `el` | 304 | 304 | 0 | ✓ |
| Vaadin Icons | `vaadin` | 636 | 636 | 0 | ✓ |
| WebHostingHub Glyphs | `whh` | 2,125 | 2,125 | 0 | ✓ |
| SmartIcons Glyph | `si-glyph` | 799 | 799 | 0 | ✓ |
| Ligature Symbols | `ls` | 348 | 348 | 0 | ✓ |
| Icalicons | `il` | 84 | 84 | 0 | ✓ |
| Web Symbols Liga | `websymbol` | 85 | 85 | 0 | ✓ |
| Fontelico | `fontelico` | 34 | 34 | 0 | ✓ |
| PrestaShop Icons | `ps` | 479 | 479 | 0 | ✓ |
| Feather Icons | `feather` | 286 | 286 | 0 | ✓ |
| Mono Icons | `mono-icons` | 180 | 180 | 0 | ✓ |
| Clarity | `clarity` | 1,103 | 1,104 | -1 | ✓ |
| Bootstrap Icons | `bi` | 2,078 | 2,080 | -2 | ✓ |
...
| Remix Icon | `ri` | 3,188 | 3,241 | -53 | ✓ |
| Boxicons Brands | `bxl` | 295 | 300 | -5 | ✓ |
| Pepicons Pop! | `pepicons-pop` | 1,275 | 1,298 | -23 | ✓ |
| IconaMoon | `iconamoon` | 1,781 | 1,818 | -37 | ✓ |
| NRK Core Icons | `nrk` | 236 | 241 | -5 | ✓ |
| Akar Icons | `akar-icons` | 454 | 464 | -10 | ✓ |
| Unicons | `uil` | 1,215 | 1,242 | -27 | ✓ |
| Font Awesome 5 Solid | `fa-solid` | 1,001 | 1,024 | -23 | ✓ |
...
| Quill Icons | `quill` | 140 | 146 | -6 | ✓ |
| Web3 Icons | `token` | 1,772 | 1,854 | -82 | ✓ |
| Font Awesome 6 Brands | `fa6-brands` | 495 | 518 | -23 | ✓ |
| Material Line Icons | `line-md` | 1,218 | 1,279 | -61 | ✓ |
| Carbon | `carbon` | 2,526 | 2,678 | -152 | ✓ |
| ProIcons | `proicons` | 539 | 572 | -33 | ✓ |
| Material Design Light | `mdi-light` | 284 | 304 | -20 | ✓ |
| Gala Icons | `gala` | 51 | 55 | -4 | ✓ |
| Vesper Icons | `vs` | 159 | 172 | -13 | ✓ |
...
| Emoji One (Monotone) | `emojione-monotone` | 1,403 | 1,673 | -270 | ✓ |
| Iconoir | `iconoir` | 1,671 | 2,019 | -348 | ✓ |
| Material Symbols | `material-symbols` | 15,369 | 18,575 | -3206 | ✓ |
| Octicons | `octicon` | 729 | 929 | -200 | ✓ |
| Streamline | `streamline` | 3,000 | 4,002 | -1002 | ✓ |
| Pixelarticons | `pixelarticons` | 800 | 1,099 | -299 | ✓ |
| Majesticons | `majesticons` | 760 | 1,045 | -285 | ✓ |
| Icons8 Windows 8 Icons | `wpf` | 200 | 283 | -83 | ✓ |
| Line Awesome | `la` | 1,544 | 2,330 | -786 | ✓ |
| Lineicons | `lineicons` | 606 | 962 | -356 | ✓ |
| coolicons | `ci` | 442 | 716 | -274 | ✓ |
| Health Icons | `healthicons` | 2,024 | 3,373 | -1349 | ✓ |
| HeroIcons v1 Outline | `heroicons-outline` | 230 | 385 | -155 | ✓ |
| HeroIcons v1 Solid | `heroicons-solid` | 230 | 389 | -159 | ✓ |
| Material Design Icons | `mdi` | 7,447 | 13,998 | -6551 | ✓ |
| IonIcons | `ion` | 1,357 | 2,601 | -1244 | ✓ |
| Ant Design Icons | `ant-design` | 830 | 1,869 | -1039 | ✓ |
| Weather Icons | `wi` | 219 | 601 | -382 | ✓ |
| Maki | `maki` | 215 | 602 | -387 | ✓ |
| BoxIcons v2 | `bx` | 814 | 2,422 | -1608 | ✓ |
