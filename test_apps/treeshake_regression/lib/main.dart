...
void main() => runApp(MaterialApp(home: Scaffold(body: Center(
  child: Wrap(spacing: 16, children: [
    ...
    for (final i in [IcIcons.baselineHome, IcIcons.baselineSearch, IcIcons.baselineMenu, IcIcons.baselineFavorite, IcIcons.baselinePerson]) IconifyIcon(i, size: 48),
    for (final i in [SolarIcons.homeOutline, SolarIcons.userOutline, SolarIcons.menuDotsOutline, SolarIcons.heartOutline, SolarIcons.bellOutline]) IconifyIcon(i, size: 48),
